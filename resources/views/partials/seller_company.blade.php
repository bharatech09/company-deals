        ...
        <article>
            ...
            <div class="collapse" id="moreDetailss{{ $company['id'] }}">
                        <ul class="feature-list mt-2">
                            ...
                            <li>Profit After Tax (2025): ₹{{ number_format($company['profit_amount1']) }}
                                {{ $company['profit_unit1'] }}</li>
                            <li>Profit After Tax (2024): ₹{{ number_format($company['profit_amount2']) }}
            ...
            <div class="row">
                @if($company['status'] == 'inactive')
                    <div class="col-md-6">
                        <a class="cta-primary mt-4"
                            href="{{ route('user.seller.company.payment', ['company_id' => $company['id']]) }}">Payment
                            Pending</a>
                    </div>
                @endif
                @if($company['deal_closed'] != 1)

      ...
      <br>
        ...
        <form action="{{ route('admin.announcement.update') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" name="title"  class="form-control" id="title" placeholder="Title" value="{{ old('title', $announcement->title) }}" required>
          </div>
          <div class="form-group">
            <label for="announcement_date">Date</label>
            <input type="text" name="announcement_date"  class="form-control datepicker" id="announcement_date" placeholder="
            Date" value="{{ old('announcement_date',date_format(date_create($announcement->announcement_date),'Y-m-d')) }}" required>
           
          </div>
          <div class="form-group">
            <label for="description">Description</label>
            <textarea name="description"  class="form-control" id="description" placeholder="Description">{{ old('description', $announcement->description) }}</textarea>

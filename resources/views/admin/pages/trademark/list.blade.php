          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="{{ route('admin.trademark.payment', ['service_id' => $trademark->id, 'service_type' => 'seller_trademark']) }}">
                    Seller Payment
                  </a>
                </td>
                <td>
                ...
                <td class="text-center">{{ $trademark->created_at->timezone('Asia/Kolkata')->format('d-m-Y h:i A') }}</td>
                <td>
                  <form action="{{ route('admin.trademark.destroy', $trademark->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this trademark?');">
                    @csrf
                    @method('DELETE')
